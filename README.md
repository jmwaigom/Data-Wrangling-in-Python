...
This would require him to gather and clean a large and messy data that's housed in different locations. At the moment, he is very busy working on 
another project, so he has assigned you the task to clean the data. He has provided you with all the folders where the data is located. To make his job 
easier, he wants to see all the data he needs for analysis condensed in one file, transformed and ready to be used. He also wants to know if there are any 
limitations that he would need to be aware of. This project was assigned to him recently, so he hasn't had a chance to look at the data and figure out
...
trends over the four months. He doesn't need to analyze reviews at the moment. Also, he only needs to analyze the same properties over the four months. 
